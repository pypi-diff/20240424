# Comparing `tmp/pypipr-1.0.9.tar.gz` & `tmp/pypipr-1.0.90.tar.gz`
...
## Comparing `pypipr-1.0.9.tar` & `pypipr-1.0.90.tar`
...
### Comparing `pypipr-1.0.9/pypipr/engineering.py` & `pypipr-1.0.90/pypipr/iengineering/calculate.py`
