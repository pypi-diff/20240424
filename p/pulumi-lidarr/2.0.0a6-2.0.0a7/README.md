# Comparing `tmp/pulumi_lidarr-2.0.0a6.tar.gz` & `tmp/pulumi_lidarr-2.0.0a7.tar.gz`
...
### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/mediamanagement/get_root_folders.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/mediamanagement/get_root_folders.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/mediamanagement/media_management.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/mediamanagement/media_management.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/mediamanagement/naming.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/mediamanagement/naming.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/mediamanagement/outputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/mediamanagement/outputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/mediamanagement/root_folder.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/mediamanagement/root_folder.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/config.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/config.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/get_config.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/get_config.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/get_consumers.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/get_consumers.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/get_metadata.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/get_metadata.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/kodi.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/kodi.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/metadata.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/metadata.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/outputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/outputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/roksbox.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/roksbox.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/metadata/wdtv.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/metadata/wdtv.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/__init__.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/__init__.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/apprise.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/apprise.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/custom_script.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/custom_script.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/discord.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/discord.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/email.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/email.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/emby.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/emby.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/get_notification.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/get_notification.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/get_notifications.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/get_notifications.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/gotify.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/gotify.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/join.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/join.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/kodi.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/kodi.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/mailgun.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/mailgun.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/notifiarr.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/notifiarr.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/notification.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/notification.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/ntfy.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/ntfy.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/outputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/outputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/plex.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/plex.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/prowl.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/prowl.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/pushbullet.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/pushbullet.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/pushover.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/pushover.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/sendgrid.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/sendgrid.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/signal.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/signal.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/simplepush.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/simplepush.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/slack.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/slack.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/subsonic.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/subsonic.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/synology_indexer.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/synology_indexer.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/telegram.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/telegram.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/twitter.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/twitter.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/notifications/webhook.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/notifications/webhook.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/__init__.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/__init__.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/_inputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/_inputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/custom_format.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/custom_format.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/delay_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/delay_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_condition.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_condition.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_condition_release_group.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_condition_release_group.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_condition_release_title.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_condition_release_title.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_condition_size.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_condition_size.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_custom_format.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_custom_format.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_custom_formats.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_custom_formats.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_delay_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_delay_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_delay_profiles.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_delay_profiles.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_metadata_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_metadata_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_metadata_profiles.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_metadata_profiles.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_primary_album_type.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_primary_album_type.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_primary_album_types.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_primary_album_types.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_quality.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_quality.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_quality_definition.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_quality_definition.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_quality_definitions.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_quality_definitions.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_quality_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_quality_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_quality_profiles.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_quality_profiles.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_release_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_release_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_release_profiles.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_release_profiles.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_release_status.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_release_status.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_release_statuses.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_release_statuses.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_secondary_album_type.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_secondary_album_type.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/get_secondary_album_types.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/get_secondary_album_types.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/metadata_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/metadata_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/outputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/outputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/quality_definition.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/quality_definition.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/quality_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/quality_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/profiles/release_profile.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/profiles/release_profile.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/provider.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/provider.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/system/_inputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/system/_inputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/system/get_host.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/system/get_host.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/system/get_status.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/system/get_status.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/system/host.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/system/host.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/system/outputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/system/outputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/tags/get_tag.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/tags/get_tag.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/tags/get_tags.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/tags/get_tags.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/tags/outputs.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/tags/outputs.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr/tags/tag.py` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr/tags/tag.py`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr.egg-info/PKG-INFO` & `pulumi_lidarr-2.0.0a7/README.md`
...
### Comparing `pulumi_lidarr-2.0.0a6/pulumi_lidarr.egg-info/SOURCES.txt` & `pulumi_lidarr-2.0.0a7/pulumi_lidarr.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pulumi_lidarr-2.0.0a6/setup.py` & `pulumi_lidarr-2.0.0a7/setup.py`
