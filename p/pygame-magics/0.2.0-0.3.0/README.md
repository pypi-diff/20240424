# Comparing `tmp/pygame-magics-0.2.0.tar.gz` & `tmp/pygame_magics-0.3.0.tar.gz`
...
## Comparing `pygame-magics-0.2.0.tar` & `pygame_magics-0.3.0.tar`
...
### Comparing `pygame-magics-0.2.0/PKG-INFO` & `pygame_magics-0.3.0/PKG-INFO`
...
### Comparing `pygame-magics-0.2.0/pygame/camera/camera.py` & `pygame_magics-0.3.0/pygame_magics/camera/camera.py`
...
### Comparing `pygame-magics-0.2.0/pygame_magics.egg-info/PKG-INFO` & `pygame_magics-0.3.0/pygame_magics.egg-info/PKG-INFO`
...
### Comparing `pygame-magics-0.2.0/setup.py` & `pygame_magics-0.3.0/setup.py`
