# Comparing `tmp/TitanDevice-0.2.7.tar.gz` & `tmp/TitanDevice-0.2.8.tar.gz`
...
## Comparing `TitanDevice-0.2.7.tar` & `TitanDevice-0.2.8.tar`
...
### Comparing `TitanDevice-0.2.7/PKG-INFO` & `TitanDevice-0.2.8/PKG-INFO`
...
### Comparing `TitanDevice-0.2.7/TitanDevice.egg-info/PKG-INFO` & `TitanDevice-0.2.8/TitanDevice.egg-info/PKG-INFO`
...
### Comparing `TitanDevice-0.2.7/setup.py` & `TitanDevice-0.2.8/setup.py`
...
### Comparing `TitanDevice-0.2.7/titan/__init__.py` & `TitanDevice-0.2.8/titan/__init__.py`

 * *Files identical despite different names*

### Comparing `TitanDevice-0.2.7/titan/_device_exception.py` & `TitanDevice-0.2.8/titan/_device_exception.py`

 * *Files identical despite different names*

### Comparing `TitanDevice-0.2.7/titan/_device_manager.py` & `TitanDevice-0.2.8/titan/_device_manager.py`
