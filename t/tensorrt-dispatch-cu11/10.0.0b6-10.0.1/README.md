# Comparing `tmp/tensorrt_dispatch-cu11-10.0.0b6.tar.gz` & `tmp/tensorrt_dispatch-cu11-10.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tensorrt_dispatch-cu11-10.0.0b6.tar", last modified: Thu Mar 14 04:45:27 2024, max compression
+gzip compressed data, was "tensorrt_dispatch-cu11-10.0.1.tar", last modified: Mon Apr 15 23:42:58 2024, max compression
```

## Comparing `tensorrt_dispatch-cu11-10.0.0b6.tar` & `tensorrt_dispatch-cu11-10.0.1.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-03-14 04:45:27.801966 tensorrt_dispatch-cu11-10.0.0b6/
--rw-r--r--   0 root         (0) root         (0)    46961 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/LICENSE.txt
--rw-r--r--   0 root         (0) root         (0)     1536 2024-03-14 04:45:27.801966 tensorrt_dispatch-cu11-10.0.0b6/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      107 2024-03-14 04:45:27.801966 tensorrt_dispatch-cu11-10.0.0b6/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     5840 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-03-14 04:45:27.801966 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch/
--rw-r--r--   0 root         (0) root         (0)      763 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch/__init__.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-03-14 04:45:27.801966 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/
--rw-r--r--   0 root         (0) root         (0)     1536 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      330 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       15 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       18 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/top_level.txt
--rw-r--r--   0 root         (0) root         (0)        1 2024-03-14 04:45:27.000000 tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/zip-safe
+drwxrwxrwx   0        0        0        0 2024-04-15 23:42:58.679247 tensorrt_dispatch-cu11-10.0.1/
+-rw-rw-rw-   0        0        0    47141 2024-04-15 23:42:57.000000 tensorrt_dispatch-cu11-10.0.1/LICENSE.txt
+-rw-rw-rw-   0        0        0     1568 2024-04-15 23:42:58.678247 tensorrt_dispatch-cu11-10.0.1/PKG-INFO
+-rw-rw-rw-   0        0        0      117 2024-04-15 23:42:58.682245 tensorrt_dispatch-cu11-10.0.1/setup.cfg
+-rw-rw-rw-   0        0        0     6002 2024-04-15 23:42:57.000000 tensorrt_dispatch-cu11-10.0.1/setup.py
+drwxrwxrwx   0        0        0        0 2024-04-15 23:42:58.636244 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch/
+-rw-rw-rw-   0        0        0      782 2024-04-15 23:42:57.000000 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch/__init__.py
+drwxrwxrwx   0        0        0        0 2024-04-15 23:42:58.677248 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/
+-rw-rw-rw-   0        0        0     1568 2024-04-15 23:42:58.000000 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      330 2024-04-15 23:42:58.000000 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2024-04-15 23:42:58.000000 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       15 2024-04-15 23:42:58.000000 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       18 2024-04-15 23:42:58.000000 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0        2 2024-04-15 23:42:58.000000 tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/zip-safe
```

### Comparing `tensorrt_dispatch-cu11-10.0.0b6/LICENSE.txt` & `tensorrt_dispatch-cu11-10.0.1/LICENSE.txt`
...
### Comparing `tensorrt_dispatch-cu11-10.0.0b6/PKG-INFO` & `tensorrt_dispatch-cu11-10.0.1/PKG-INFO`
...
### Comparing `tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch/__init__.py` & `tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch/__init__.py`
...
### Comparing `tensorrt_dispatch-cu11-10.0.0b6/tensorrt_dispatch_cu11.egg-info/PKG-INFO` & `tensorrt_dispatch-cu11-10.0.1/tensorrt_dispatch_cu11.egg-info/PKG-INFO`
