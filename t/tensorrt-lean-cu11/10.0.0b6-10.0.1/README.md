# Comparing `tmp/tensorrt_lean-cu11-10.0.0b6.tar.gz` & `tmp/tensorrt_lean-cu11-10.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tensorrt_lean-cu11-10.0.0b6.tar", last modified: Thu Mar 14 04:45:27 2024, max compression
+gzip compressed data, was "tensorrt_lean-cu11-10.0.1.tar", last modified: Mon Apr 15 23:42:58 2024, max compression
```

## Comparing `tensorrt_lean-cu11-10.0.0b6.tar` & `tensorrt_lean-cu11-10.0.1.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-03-14 04:45:27.757964 tensorrt_lean-cu11-10.0.0b6/
--rw-r--r--   0 root         (0) root         (0)    46961 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/LICENSE.txt
--rw-r--r--   0 root         (0) root         (0)     1532 2024-03-14 04:45:27.757964 tensorrt_lean-cu11-10.0.0b6/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      107 2024-03-14 04:45:27.757964 tensorrt_lean-cu11-10.0.0b6/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     5832 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-03-14 04:45:27.753963 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean/
--rw-r--r--   0 root         (0) root         (0)      763 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean/__init__.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2024-03-14 04:45:27.757964 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/
--rw-r--r--   0 root         (0) root         (0)     1532 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      302 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       15 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       14 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/top_level.txt
--rw-r--r--   0 root         (0) root         (0)        1 2024-03-14 04:45:27.000000 tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/zip-safe
+drwxrwxrwx   0        0        0        0 2024-04-15 23:42:58.301238 tensorrt_lean-cu11-10.0.1/
+-rw-rw-rw-   0        0        0    47141 2024-04-15 23:42:56.000000 tensorrt_lean-cu11-10.0.1/LICENSE.txt
+-rw-rw-rw-   0        0        0     1564 2024-04-15 23:42:58.300237 tensorrt_lean-cu11-10.0.1/PKG-INFO
+-rw-rw-rw-   0        0        0      117 2024-04-15 23:42:58.304240 tensorrt_lean-cu11-10.0.1/setup.cfg
+-rw-rw-rw-   0        0        0     5994 2024-04-15 23:42:56.000000 tensorrt_lean-cu11-10.0.1/setup.py
+drwxrwxrwx   0        0        0        0 2024-04-15 23:42:58.247237 tensorrt_lean-cu11-10.0.1/tensorrt_lean/
+-rw-rw-rw-   0        0        0      782 2024-04-15 23:42:56.000000 tensorrt_lean-cu11-10.0.1/tensorrt_lean/__init__.py
+drwxrwxrwx   0        0        0        0 2024-04-15 23:42:58.298240 tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/
+-rw-rw-rw-   0        0        0     1564 2024-04-15 23:42:58.000000 tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      302 2024-04-15 23:42:58.000000 tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2024-04-15 23:42:58.000000 tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       15 2024-04-15 23:42:58.000000 tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       14 2024-04-15 23:42:58.000000 tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0        2 2024-04-15 23:42:58.000000 tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/zip-safe
```

### Comparing `tensorrt_lean-cu11-10.0.0b6/LICENSE.txt` & `tensorrt_lean-cu11-10.0.1/LICENSE.txt`
...
### Comparing `tensorrt_lean-cu11-10.0.0b6/PKG-INFO` & `tensorrt_lean-cu11-10.0.1/PKG-INFO`
...
### Comparing `tensorrt_lean-cu11-10.0.0b6/tensorrt_lean/__init__.py` & `tensorrt_lean-cu11-10.0.1/tensorrt_lean/__init__.py`
...
### Comparing `tensorrt_lean-cu11-10.0.0b6/tensorrt_lean_cu11.egg-info/PKG-INFO` & `tensorrt_lean-cu11-10.0.1/tensorrt_lean_cu11.egg-info/PKG-INFO`
