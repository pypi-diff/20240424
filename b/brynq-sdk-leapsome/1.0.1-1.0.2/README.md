# Comparing `tmp/brynq_sdk_leapsome-1.0.1.tar.gz` & `tmp/brynq_sdk_leapsome-1.0.2.tar.gz`
...
## Comparing `brynq_sdk_leapsome-1.0.1.tar` & `brynq_sdk_leapsome-1.0.2.tar`
...
### Comparing `brynq_sdk_leapsome-1.0.1/brynq_sdk/leapsome/api_interface.py` & `brynq_sdk_leapsome-1.0.2/brynq_sdk/leapsome/api_interface.py`

 * *Files identical despite different names*

### Comparing `brynq_sdk_leapsome-1.0.1/brynq_sdk/leapsome/sftp_interface.py` & `brynq_sdk_leapsome-1.0.2/brynq_sdk/leapsome/sftp_interface.py`
