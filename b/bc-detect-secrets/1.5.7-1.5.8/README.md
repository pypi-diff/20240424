# Comparing `tmp/bc-detect-secrets-1.5.7.tar.gz` & `tmp/bc-detect-secrets-1.5.8.tar.gz`
...
### Comparing `bc-detect-secrets-1.5.7/README.md` & `bc-detect-secrets-1.5.8/README.md`
