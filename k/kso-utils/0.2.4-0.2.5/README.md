# Comparing `tmp/kso_utils-0.2.4.tar.gz` & `tmp/kso_utils-0.2.5.tar.gz`
...
## Comparing `kso_utils-0.2.4.tar` & `kso_utils-0.2.5.tar`
...
### Comparing `kso_utils-0.2.4/LICENSE` & `kso_utils-0.2.5/LICENSE`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/README.md` & `kso_utils-0.2.5/README.md`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/db_starter/cdn_projects_list.csv` & `kso_utils-0.2.5/kso_utils/db_starter/cdn_projects_list.csv`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/db_starter/projects_list.csv` & `kso_utils-0.2.5/kso_utils/db_starter/projects_list.csv`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/db_starter/schema.py` & `kso_utils-0.2.5/kso_utils/db_starter/schema.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/db_utils.py` & `kso_utils-0.2.5/kso_utils/db_utils.py`
...
### Comparing `kso_utils-0.2.4/kso_utils/frame_utils.py` & `kso_utils-0.2.5/kso_utils/frame_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/general.py` & `kso_utils-0.2.5/kso_utils/general.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/koster_utils.py` & `kso_utils-0.2.5/kso_utils/koster_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/movie_utils.py` & `kso_utils-0.2.5/kso_utils/movie_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/project.py` & `kso_utils-0.2.5/kso_utils/project.py`
...
### Comparing `kso_utils-0.2.4/kso_utils/project_utils.py` & `kso_utils-0.2.5/kso_utils/project_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/server_utils.py` & `kso_utils-0.2.5/kso_utils/server_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/sgu_utils.py` & `kso_utils-0.2.5/kso_utils/sgu_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/spyfish_utils.py` & `kso_utils-0.2.5/kso_utils/spyfish_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/video_reader.py` & `kso_utils-0.2.5/kso_utils/video_reader.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/widgets.py` & `kso_utils-0.2.5/kso_utils/widgets.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/yolo_utils.py` & `kso_utils-0.2.5/kso_utils/yolo_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/zenodo_utils.py` & `kso_utils-0.2.5/kso_utils/zenodo_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/kso_utils/zooniverse_utils.py` & `kso_utils-0.2.5/kso_utils/zooniverse_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.4/pyproject.toml` & `kso_utils-0.2.5/pyproject.toml`
...
### Comparing `kso_utils-0.2.4/setup.py` & `kso_utils-0.2.5/setup.py`
...
### Comparing `kso_utils-0.2.4/PKG-INFO` & `kso_utils-0.2.5/PKG-INFO`
