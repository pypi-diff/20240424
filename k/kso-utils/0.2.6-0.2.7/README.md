# Comparing `tmp/kso_utils-0.2.6.tar.gz` & `tmp/kso_utils-0.2.7.tar.gz`
...
+gzip compressed data, was "kso_utils-0.2.7.tar", max compression
```

## Comparing `kso_utils-0.2.6.tar` & `kso_utils-0.2.7.tar`
...
+-rw-r--r--   0        0        0    35126 2023-09-21 14:24:50.986126 kso_utils-0.2.7/LICENSE
+-rw-r--r--   0        0        0    14312 2024-04-02 13:24:27.140946 kso_utils-0.2.7/README.md
+-rw-r--r--   0        0        0        0 2023-09-21 14:24:50.996729 kso_utils-0.2.7/kso_utils/__init__.py
+-rw-r--r--   0        0        0        0 2023-09-21 14:24:50.996795 kso_utils-0.2.7/kso_utils/db_starter/__init__.py
+-rw-r--r--   0        0        0     1079 2024-04-02 13:24:18.424978 kso_utils-0.2.7/kso_utils/db_starter/cdn_projects_list.csv
+-rw-r--r--   0        0        0     1461 2024-02-28 09:49:51.234739 kso_utils-0.2.7/kso_utils/db_starter/projects_list.csv
+-rw-r--r--   0        0        0     2006 2024-04-24 12:12:31.388388 kso_utils-0.2.7/kso_utils/db_starter/schema.py
+-rw-r--r--   0        0        0    18574 2024-04-24 09:19:37.426261 kso_utils-0.2.7/kso_utils/db_utils.py
+-rw-r--r--   0        0        0     6741 2024-04-02 13:24:18.426034 kso_utils-0.2.7/kso_utils/frame_utils.py
+-rw-r--r--   0        0        0     4091 2023-09-22 19:06:03.217864 kso_utils-0.2.7/kso_utils/general.py
+-rw-r--r--   0        0        0    13317 2024-04-02 13:24:18.426336 kso_utils-0.2.7/kso_utils/koster_utils.py
+-rw-r--r--   0        0        0    31563 2024-04-02 13:24:18.426758 kso_utils-0.2.7/kso_utils/movie_utils.py
+-rw-r--r--   0        0        0    97323 2024-04-24 09:19:15.263961 kso_utils-0.2.7/kso_utils/project.py
+-rw-r--r--   0        0        0     3606 2024-04-02 13:24:18.428216 kso_utils-0.2.7/kso_utils/project_utils.py
+-rw-r--r--   0        0        0    14924 2024-04-02 13:24:18.428542 kso_utils-0.2.7/kso_utils/server_utils.py
+-rw-r--r--   0        0        0     6295 2024-04-02 13:24:18.429109 kso_utils-0.2.7/kso_utils/sgu_utils.py
+-rw-r--r--   0        0        0    10031 2024-04-02 13:24:18.429517 kso_utils-0.2.7/kso_utils/spyfish_utils.py
+-rw-r--r--   0        0        0    13795 2024-04-11 09:53:06.799605 kso_utils-0.2.7/kso_utils/video_reader.py
+-rw-r--r--   0        0        0    76147 2024-04-02 13:24:18.430796 kso_utils-0.2.7/kso_utils/widgets.py
+-rw-r--r--   0        0        0    81215 2024-04-03 13:05:07.486948 kso_utils-0.2.7/kso_utils/yolo_utils.py
+-rw-r--r--   0        0        0     3347 2023-09-21 14:24:50.998838 kso_utils-0.2.7/kso_utils/zenodo_utils.py
+-rw-r--r--   0        0        0    85468 2024-04-02 13:24:18.432485 kso_utils-0.2.7/kso_utils/zooniverse_utils.py
+-rw-r--r--   0        0        0     2535 2024-04-24 12:12:54.071563 kso_utils-0.2.7/pyproject.toml
+-rw-r--r--   0        0        0    15784 1970-01-01 00:00:00.000000 kso_utils-0.2.7/setup.py
+-rw-r--r--   0        0        0    15879 1970-01-01 00:00:00.000000 kso_utils-0.2.7/PKG-INFO
```

### Comparing `kso_utils-0.2.6/LICENSE` & `kso_utils-0.2.7/LICENSE`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/README.md` & `kso_utils-0.2.7/README.md`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/db_starter/cdn_projects_list.csv` & `kso_utils-0.2.7/kso_utils/db_starter/cdn_projects_list.csv`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/db_starter/projects_list.csv` & `kso_utils-0.2.7/kso_utils/db_starter/projects_list.csv`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/db_starter/schema.py` & `kso_utils-0.2.7/kso_utils/db_starter/schema.py`
...
### Comparing `kso_utils-0.2.6/kso_utils/db_utils.py` & `kso_utils-0.2.7/kso_utils/db_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/frame_utils.py` & `kso_utils-0.2.7/kso_utils/frame_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/general.py` & `kso_utils-0.2.7/kso_utils/general.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/koster_utils.py` & `kso_utils-0.2.7/kso_utils/koster_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/movie_utils.py` & `kso_utils-0.2.7/kso_utils/movie_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/project.py` & `kso_utils-0.2.7/kso_utils/project.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/project_utils.py` & `kso_utils-0.2.7/kso_utils/project_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/server_utils.py` & `kso_utils-0.2.7/kso_utils/server_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/sgu_utils.py` & `kso_utils-0.2.7/kso_utils/sgu_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/spyfish_utils.py` & `kso_utils-0.2.7/kso_utils/spyfish_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/video_reader.py` & `kso_utils-0.2.7/kso_utils/video_reader.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/widgets.py` & `kso_utils-0.2.7/kso_utils/widgets.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/yolo_utils.py` & `kso_utils-0.2.7/kso_utils/yolo_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/zenodo_utils.py` & `kso_utils-0.2.7/kso_utils/zenodo_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/kso_utils/zooniverse_utils.py` & `kso_utils-0.2.7/kso_utils/zooniverse_utils.py`

 * *Files identical despite different names*

### Comparing `kso_utils-0.2.6/pyproject.toml` & `kso_utils-0.2.7/pyproject.toml`
...
### Comparing `kso_utils-0.2.6/setup.py` & `kso_utils-0.2.7/setup.py`
...
### Comparing `kso_utils-0.2.6/PKG-INFO` & `kso_utils-0.2.7/PKG-INFO`
