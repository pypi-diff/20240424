# Comparing `tmp/knnpe-0.1.1.tar.gz` & `tmp/knnpe-0.1.3.tar.gz`
...
+gzip compressed data, was "knnpe-0.1.3.tar", last modified: Wed Apr 24 21:01:14 2024, max compression
```

## Comparing `knnpe-0.1.1.tar` & `knnpe-0.1.3.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 21:01:14.238378 knnpe-0.1.3/
+-rw-r--r--   0 runner    (1001) docker     (127)     1191 2024-04-24 21:01:05.000000 knnpe-0.1.3/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (127)     9122 2024-04-24 21:01:14.238378 knnpe-0.1.3/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)     8395 2024-04-24 21:01:05.000000 knnpe-0.1.3/README.rst
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 21:01:14.234378 knnpe-0.1.3/knnpe/
+-rw-r--r--   0 runner    (1001) docker     (127)       20 2024-04-24 21:01:05.000000 knnpe-0.1.3/knnpe/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)    14964 2024-04-24 21:01:05.000000 knnpe-0.1.3/knnpe/knnpe.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 21:01:14.238378 knnpe-0.1.3/knnpe/rwalk/
+-rw-r--r--   0 runner    (1001) docker     (127)       21 2024-04-24 21:01:05.000000 knnpe-0.1.3/knnpe/rwalk/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     7989 2024-04-24 21:01:05.000000 knnpe-0.1.3/knnpe/rwalk/config.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-24 21:01:14.238378 knnpe-0.1.3/knnpe.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)     9122 2024-04-24 21:01:14.000000 knnpe-0.1.3/knnpe.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      247 2024-04-24 21:01:14.000000 knnpe-0.1.3/knnpe.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-24 21:01:14.000000 knnpe-0.1.3/knnpe.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        6 2024-04-24 21:01:14.000000 knnpe-0.1.3/knnpe.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (127)      759 2024-04-24 21:01:05.000000 knnpe-0.1.3/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (127)      588 2024-04-24 21:01:14.238378 knnpe-0.1.3/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (127)      777 2024-04-24 21:01:05.000000 knnpe-0.1.3/setup.py
```

### Comparing `knnpe-0.1.1/LICENSE` & `knnpe-0.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `knnpe-0.1.1/PKG-INFO` & `knnpe-0.1.3/PKG-INFO`
...
### Comparing `knnpe-0.1.1/README.rst` & `knnpe-0.1.3/README.rst`
...
### Comparing `knnpe-0.1.1/knnpe/knnpe.py` & `knnpe-0.1.3/knnpe/knnpe.py`
...
### Comparing `knnpe-0.1.1/knnpe/rwalk/config.py` & `knnpe-0.1.3/knnpe/rwalk/config.py`

 * *Files identical despite different names*

### Comparing `knnpe-0.1.1/knnpe.egg-info/PKG-INFO` & `knnpe-0.1.3/knnpe.egg-info/PKG-INFO`
...
### Comparing `knnpe-0.1.1/pyproject.toml` & `knnpe-0.1.3/pyproject.toml`
...
### Comparing `knnpe-0.1.1/setup.cfg` & `knnpe-0.1.3/setup.cfg`
...
### Comparing `knnpe-0.1.1/setup.py` & `knnpe-0.1.3/setup.py`
