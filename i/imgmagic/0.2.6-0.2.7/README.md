# Comparing `tmp/imgmagic-0.2.6-py3-none-any.whl.zip` & `tmp/imgmagic-0.2.7-py3-none-any.whl.zip`
...
## Comparing `imgmagic-0.2.6.dist-info/METADATA` & `imgmagic-0.2.7.dist-info/METADATA`
