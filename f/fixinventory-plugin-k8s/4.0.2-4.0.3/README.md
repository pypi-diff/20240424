# Comparing `tmp/fixinventory-plugin-k8s-4.0.2.tar.gz` & `tmp/fixinventory_plugin_k8s-4.0.3.tar.gz`
...
### Comparing `fixinventory-plugin-k8s-4.0.2/PKG-INFO` & `fixinventory_plugin_k8s-4.0.3/PKG-INFO`
